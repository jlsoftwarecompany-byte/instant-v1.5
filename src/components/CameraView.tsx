        ...
        {permissionError ? (
          <div className="max-w-xs p-6 text-center space-y-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-white dark:bg-zinc-800 text-black dark:text-white text-xs font-bold rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-700 transition cursor-pointer border border-white/20 dark:border-white/10"
            >
        ...
        {capturedPhoto ? (
          ...
          <div className="flex items-center gap-5 w-full max-w-sm">
            <button
              ...
              className="flex-1 py-3.5 bg-black dark:bg-zinc-900 border border-white/20 hover:bg-black/80 dark:hover:bg-zinc-800 text-white text-xs font-black uppercase tracking-wider rounded-xl transition flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
            >
          ...
          <div className="flex items-center justify-between w-full max-w-sm">
            ...
            <button
              ...
              disabled={!!permissionError}
              className="w-12 h-12 rounded-full bg-white dark:bg-zinc-900 border border-black/20 dark:border-white/10 text-black dark:text-white flex items-center justify-center hover:bg-zinc-100 dark:hover:bg-zinc-800 active:scale-90 transition cursor-pointer"
